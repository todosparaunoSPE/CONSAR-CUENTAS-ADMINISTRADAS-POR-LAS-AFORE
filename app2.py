...
def main():
    ...
    st.sidebar.info("""
        ...
        1. **Seleccionar Hoja:** Elija la hoja deseada del archivo cargado.
        2. **Filtrar Datos:** Seleccione una descripción del concepto para filtrar los datos.
        3. **Ver Datos y Estadísticas:** Visualice los datos filtrados y sus estadísticas descriptivas.
        4. **Proyección de Datos:** Seleccione un modelo (SARIMA o Suavizado Exponencial) para proyectar datos futuros.
        5. **Ver Proyecciones:** Visualice los datos originales y las proyecciones en gráficos interactivos.
    """)

    st.title('CONSAR: Cuentas Administradas por las AFORE')

    # Ruta del archivo xlsx
    file_path = 'cuentas_administradas_afores.xlsx'
